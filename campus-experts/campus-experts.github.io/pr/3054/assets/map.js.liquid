...
L.tileLayer(
  'https://api.mapbox.com/styles/v1/github/cjhhxery8665u2sqcpantwo5o/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZ2l0aHViIiwiYSI6ImNqaGh3Z2p1ZDA3ZngzNm1wMmVrbmVnM3MifQ.xsTr-3ER9TPJuzODE-_dtw',
  {
    maxZoom: 18,
  }
).addTo(map);
