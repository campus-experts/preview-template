...
function onEachFeature(feature, layer) {
  ...
  if (feature.properties) {
      layer.bindPopup(function(){
        ...
        return "<a href='"+feature.properties.url+"' target='_blank' >"+popupstring+"</a><p>"+feature.properties.description+" <br> "+feature.properties.city+", "+feature.properties.date+"</p>";
      });
  }
}